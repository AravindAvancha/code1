  ...
  return (
    <div style={{ fontFamily: "Arial, sans-serif", color: "#333", marginTop: "30px" }}>
      ...
      {bookingStep === "form" && (
        <div>
          <div style={{ textAlign: "center", marginBottom: "20px" }}>
            <p style={{ fontSize: "1.2rem", color: "#555", marginBottom: "20px",marginTop:"60px" }}>
...
export default ContinuousBookingPage;
